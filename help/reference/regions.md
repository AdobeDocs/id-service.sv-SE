...
Mer information finns i [Hämta användar-ID:n och regioner via Experience Cloud-identitetstjänsten](https://docs.adobe.com/content/help/en/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-apis/dcs-mcid-ids.html).

Om du är [!DNL Audience Manager] kund kan du hämta region-ID:t från svaret som skickas av DCS-servern (Data Collection Server). See [Get User IDs and Regions from a DCS Response](https://docs.adobe.com/content/help/en/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-apis/dcs-aam-ids.html).
