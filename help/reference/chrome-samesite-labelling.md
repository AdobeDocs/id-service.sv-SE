...
>  Cookies från tredje part från Adobe är inställda på serversidan.

Mer information finns i dokumentet om [Målets Google Chrome SameSite-principer](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/google-chrome-samesite-cookie-policies.html).
