...
Ytterligare kontroller som hjälper dig att avgöra om ID-tjänsten fungerar som den ska finns i [Testa och verifiera Experience Cloud identitetstjänst](../implementation-guides/test-verify.md).
