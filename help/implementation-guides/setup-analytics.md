...
>[!NOTE]
>
>Om det används matchar du URL:erna för [!DNL Experience Cloud]-servern med deras motsvarande URL:er för spårningsservern så här:
>
...
* Kontrollera att ID:t [!DNL Analytics] (AID) och MID finns i bildbegäran.
