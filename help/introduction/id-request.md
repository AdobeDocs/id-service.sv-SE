...
>[!NOTE]
>
>Om du inte känner till hur besökar-ID skapas i Experience Cloud Identity Service kan du titta på [Experience Cloud](../introduction/cookies.md).

**Tips:** Se även vår video om  [ID-tjänster om domänövergripande spårning](https://helpx.adobe.com/marketing-cloud-core/kb/MCID/CrossDomain.html).
...
## Begäran och svar över flera webbplatser {#section-15ea880453af467abd2874b8b4ed6ee9}
...
Under dessa förhållanden finns det ingen AMCV-cookie på tacos-sajten. Och ID-tjänsten kan inte använda AMCV-cookie-filen på pizzabiten eftersom den är specifik för pizzabdomänen. Därför måste ID-tjänsten anropa DCS för att söka efter och begära ett besökar-ID. I det här fallet innehåller DCS-anropet Livsmedelsföretagets organisations-ID *och* demdex-ID:t. Och kom ihåg att demdex-ID hämtas från pizzabiten och lagras som en cookie från tredje part i domänen demdex.net.
...
## ID-begäranden från andra webbplatser {#section-ba9a929e50d64b0aba080630fd83b6f1}
